  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(255, 20, 147, 0.6) 0%, rgba(199, 21, 133, 0.4) 50%, transparent 70%)',
          animationDelay: '-10s'
        }}
      />
        <div className="relative z-10 flex flex-col pt-12 items-center justify-center text-center px-4">
          {/* <div className="mb-4 w-12 h-12 bg-white/10 backdrop-blur-md rounded-lg flex items-center justify-center border border-white/20 animate-float">
          ...
          <p className="text-sm md:text-base text-white/80 mb-4 max-w-xs leading-relaxed animate-slideUp-delay">
            Experience the next generation of AI-powered conversations and unlock endless possibilities.
          </p>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(45deg, #4a90e2 0%, #357abd 50%, #1e3a8a 100%)',
          boxShadow: 'inset -8px -8px 15px rgba(0,0,0,0.5), 0 0 15px rgba(74, 144, 226, 0.3)'
        }}
      >
        <div
      ...
      <div className="absolute right-4 bottom-10  animate-astronaut-float">
        <div
          ...
          style={{
            boxShadow: 'inset 3px 3px 8px rgba(255,255,255,0.3), inset -3px -3px 8px rgba(0,0,0,0.2), 0 0 15px rgba(255,255,255,0.1)'
          }}
        >
          <div
            className="absolute -top-4 left-1.5 w-16 h-16 rounded-full border-2 border-gray-400"
            style={{
              background: 'linear-gradient(145deg, rgba(255,255,255,0.9) 0%, rgba(200,200,255,0.8) 100%)',
              boxShadow: 'inset 0 0 8px rgba(135, 206, 250, 0.3), 0 0 15px rgba(255,255,255,0.2)'
            }}
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(145deg, rgba(0,100,200,0.5) 0%, rgba(0,50,150,0.3) 100%)'
              }}
            />
          </div>
          ...
          <div className="absolute top-14 left-5 w-8 h-5 bg-gradient-to-br from-gray-700 to-gray-900 rounded-md">
            <div className="flex justify-around items-center h-full px-1">
              ...
              <div className="w-1 h-1 bg-blue-500 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
          </div>
